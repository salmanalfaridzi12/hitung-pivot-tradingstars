...
# 2. Clear
clear_old = '''setCurrentPrice("");setResult(null);setProgress(0);setGlowLevel(null);setAlertPrice("");};'''
clear_new = '''setCurrentPrice("");setResult(null);setProgress(0);setGlowLevel(null);};'''
code = code.replace(clear_old, clear_new)

# 3. Hitung
hitung_old = '''setResult(res);setLoading(false);setAlertPrice(Math.round(r1) || h);'''
hitung_new = '''setResult(res);setLoading(false);'''
